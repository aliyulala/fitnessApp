package com.example.fitnes.adapter;
...
import com.example.fitnes.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        holder.recyclerRowBinding.recylecrViewUserEmailText.setText(postArrayList.get(position).email);
